...
<div id="store-order-div" class="store_order admin-view-stores" >
	<div align="center"><h1><spring:message code="order.current.orders" /></h1></div>
	<br/><br/>
	<form:form action="store-current-order" modelAttribute="order" method="POST">
		<table>
		    <tr>
	...
	<table id="demoTable" class="store_table">
	  <thead>
		<tr>
			...
			<th><spring:message code="order.orderStatus" /></th>			
      ...
      <tbody>
		<c:forEach items="${orderList}" var="order" varStatus="status">
			<tr>
				...
				<td><a class="store_link" href="<c:url value='/seller/store-orderDetail'><c:param name='order' value='current_order'/><c:param name='orderId' value='${order.orderId}'/> </c:url>"><label style="text-decoration:underline;"> <spring:message code="viewDetail" /></label>
				   </a>
				</td>
			</tr>
		</c:forEach>
