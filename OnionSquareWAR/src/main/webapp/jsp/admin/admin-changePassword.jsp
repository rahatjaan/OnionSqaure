...
<script type="text/javascript">
	...
	$(function() {	
					...
					$("#admin-changePassword-form").validate({					
						rules : {						
	 ...
	 function resetForm(){
		  $("#admin-changePassword-form").find("input").val("");
		  $("#admin-changePassword-form").find("select").val("0");
		  $(".error").text("");
		  return false;
	  }
...
<div id="admin-changePassword"  align="center" class="admin_home_container">
<h1><spring:message code="admin.change.password" /></h1>
	
	<form:form action="changePassword" id="admin-changePassword-form" method="POST"
